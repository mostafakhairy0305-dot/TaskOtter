...
var publicTasks = []publicTaskSpec{
	...
	{name: "install:auto", requiresSummary: true},
	{name: "install:bun", requiresSummary: true},
	{name: "install:npm", requiresSummary: true},
	{name: "install:pnpm", requiresSummary: true},
	{name: "install:yarn", requiresSummary: true},
